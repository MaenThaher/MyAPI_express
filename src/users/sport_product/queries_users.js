...
const addSport = "insert into sport_product (fullname,duration,per_day,star_product,more_info,is_rented,delivery,users_fk,image_url) values($1,$2,$3,$4,$5,$6,$7,$8,$9)"
...
const getAllProducts = "select * from sport_product"
module.exports={    
    addSport,
    checkfullnameExists,
    addOwner,
